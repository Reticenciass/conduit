...
| F — namespace + Ligolo-ng | implementado em laboratório / opt-in na instalação | helper com enlace veth isolado, worker sem privilégios para proxy/ferramentas, protocolo Unix tipado, serviço systemd restrito, cleanup por identidade e escopo de workspace; Ligolo 0.9.1 e agentes amd64/arm64 por checksum; o botão só é habilitado com helper, `CAP_NET_ADMIN` e manifesto verificados |
